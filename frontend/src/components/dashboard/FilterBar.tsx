      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="relative">
          <Select
            ...
            onValueChange={(value: 'all' | 'uploaded' | 'processing' | 'pending_review' | 'completed' | 'failed') =>
        ...
        <div className="relative">
          <Select
            ...
            onValueChange={(value: 'all' | 'true' | 'false' | 'pending') =>
              onFilterChange({ ...filters, status: value })
            }
          >
            <SelectTrigger className={cn("w-[140px] h-10", filters.status !== 'all' && "pr-8")}>
              <SelectValue placeholder="是否违规" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="all">是否违规</SelectItem>
              <SelectItem value="true">有违规</SelectItem>
              <SelectItem value="false">正常</SelectItem>
              <SelectItem value="pending">未质检完成</SelectItem>
            </SelectContent>
          </Select>
          {filters.status !== 'all' && (
            <button
